    ...
    >
      <section className="flex flex-row gap-4">
        ...
        <div className="flex flex-row items-center gap-2">
          <Avatar width={24} height={24} src={fakeUser.avatarUrl} alt={fakeUser.name} />
      ...
      <section className="flex flex-row gap-6 text-light-gray-600 dark:text-white">
        ...
        <div className="absolute top-0 right-0 shadow-gray-800 dark:bg-dark-background-quaternary-surface px-6 py-8">
          <ReaderSettings />
        </div>
      </section>
    </nav>
